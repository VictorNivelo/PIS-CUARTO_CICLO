    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ManyToManyField(to='PIS.estudiante', verbose_name='Estudiantes')),
            ],
        ),
        migrations.AddField(
            model_name='carrera',
        ...
        migrations.AddField(
            ...
            name='genero',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PIS.genero', verbose_name='Género'),
        ),
        migrations.CreateModel(
            name='Materia',
            fields=[
        ...
        migrations.AddField(
            model_name='estudiante',
            name='materia',
            field=models.ManyToManyField(to='PIS.materia', verbose_name='Materias'),
        ),
        migrations.AddField(
            model_name='estudiante',
            name='tipo_dni',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PIS.tipodni', verbose_name='Tipo de DNI'),
        ),
        migrations.AddField(
            model_name='facultad',
            name='universidad',
