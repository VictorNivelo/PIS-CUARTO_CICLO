    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalidad_estudio', models.BooleanField(verbose_name='Modalidad de Estudio')),
                ('tipo_educacion', models.BooleanField(verbose_name='Tipo de Educación')),
                ('origen', models.BooleanField(verbose_name='Origen')),
                ('trabajo', models.BooleanField(verbose_name='Trabajo')),
                ('discapacidad', models.BooleanField(verbose_name='Discapacidad')),
                ('hijos', models.BooleanField(verbose_name='Hijos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materias', models.ManyToManyField(to='PIS.materia', verbose_name='Materias Asignadas')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PIS.usuario', verbose_name='Usuario')),
            ],
        ),
        migrations.CreateModel(
